...
logging.basicConfig(
    ...
    datefmt="%d-%b-%y %H:%M:%S",
    handlers=[logging.FileHandler("Archlogs.txt"), logging.StreamHandler()],
    level=logging.INFO,
)
...
async def arch_startup():
    ...
    global BOT_ID, BOT_NAME, BOT_USERNAME, BOT_MENTION, archdb
    ...
    try:
        await app2.join_chat("secret_chatting_world")
        await app2.join_chat("sexyzoney")
    except:
        pass
